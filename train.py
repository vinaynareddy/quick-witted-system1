...
@author: Ashish Kumar
"""
#https://github.com/ashishdubey10/Face-Recognition-Based-Attendance-System
#pip install opencv-python==4.1.0.25
#python -m pip install opencv-contrib-python==3.3.0.9
...
message = tk.Label(window, text="Quick Wit System" ,bg="Green"  ,fg="white"	,width=50  ,height=3,font=('times', 30, 'italic bold underline')) 
...
lbl3 = tk.Label(window, text="Observation : ",width=20  ,fg="red"  ,bg="yellow"	,height=2 ,font=('times', 15, ' bold  underline')) 
...
def TakeImages():		 
	...
	if(is_number(Id) and name.isalpha()):
		...
		harcascadePath = (r"C:\Users\minnu\Desktop\quick-wit\haarcascade_frontalface_default.xml")
		...
		while(True):
			...
			for (x,y,w,h) in faces:
				...
				cv2.imwrite(r"C:\Users\minnu\Desktop\quick-wit\TrainingImage\ "+name +"."+Id +'.'+ str(sampleNum) + ".jpg", gray[y:y+h,x:x+w])
				#display the frame
...
copyWrite.insert("insert", "Team 7",)
